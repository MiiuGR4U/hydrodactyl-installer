...
LATEST_URL=$(curl -s https://api.github.com/repos/blueprintframework/hydrodactyl/releases/latest | grep "tarball_url" | cut -d'"' -f4)
...
For Wings installation, refer to the [Wings Manual Installation Guide](./Wings-manual.md).

---

## Support

- GitHub Issues: https://github.com/blueprintframework/hydrodactyl/issues
- Documentation: https://github.com/blueprintframework/hydrodactyl/tree/main/docs
