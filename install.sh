...
error_handler() {
  ...
  if [ $exit_code -ne 0 ]; then
    ...
    echo ""
    echo -e "* ${COLOR_CYAN}For help, visit:${COLOR_NC} https://github.com/blueprintframework/hydrodactyl-installer/issues"
    echo ""
    echo -e "* ${COLOR_RED}â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”${COLOR_NC}"
    echo ""
  fi
...
show_welcome() {
  ...
  if [ "$PANEL_INSTALLED" == true ]; then
    echo -e "  ${COLOR_GREEN}âœ“${COLOR_NC} Panel installed${PANEL_VERSION:+ ($PANEL_VERSION)}"
  else
    echo -e "  ${COLOR_RED}âœ—${COLOR_NC} Panel not installed"
  fi

  if [ "$Wings_INSTALLED" == true ]; then
    echo -e "  ${COLOR_GREEN}âœ“${COLOR_NC} Wings installed${Wings_VERSION:+ ($Wings_VERSION)}"
  else
